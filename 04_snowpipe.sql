...
set STORAGE_ALLOWED_LOCATIONS = ('s3://aws-s3-shri-dev/json_data/', 's3://aws-s3-shri-dev/csv', 's3://aws-s3-shri-dev/xml_data/','s3://aws-s3-shri-dev/pipes_data/csv/');
...
CREATE OR REPLACE stage mydb.external_stages.stage_aws_pipes
    URL = 's3://aws-s3-shri-dev/pipes_data/csv/'
...
SELECT count(*) FROM mydb.public.emp_data;
